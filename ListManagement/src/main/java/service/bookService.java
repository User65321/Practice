...
public class bookService {
	...
	//登録処理
		public Map<Integer, String> Register(ModelMap modelMap,@RequestParam("Number") Integer Number,@RequestParam("Name")String Name) {
		...
		//検索処理
		public Map<Integer, String> Search(ModelMap modelMap,@RequestParam("Number")Integer Number) {
